					...
					<div class="col-lg-4 top-left card-transition">
						<div class="card card-chart">
							<div class="card-header">
								<h4 class="card-title"><i id="trig" class="material-icons">zoom_out_map</i> Institution Type</h4>
								<div class="dropdown">	
...
function loadinstitution(event, array) {
    if (array.length > 0) {
        ...
        window.location = '/institution/journal.php?inst=' + lab + '&product=' + getUrlParameter('product') + '&range=' + getUrlParameter('range') + '&startdate=' + getUrlParameter('startdate') + '&enddate=' + getUrlParameter('enddate');
