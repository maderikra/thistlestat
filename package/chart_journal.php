...
if (isset($_GET['product'])) {
	...
	$stmts = $pdo->prepare('SELECT Institution, Inst_type, SUM(Requests) as totals, start_date FROM ' . JOURNALTABLE . ' WHERE product_abbrev = :product AND start_date >= :startdate and start_date <= :enddate group by Institution, start_date order by Inst_type DESC, Institution ASC');
